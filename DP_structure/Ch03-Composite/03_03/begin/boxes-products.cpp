...
public:
    ...
    double price() const
    {
        ...
        for (const auto &m_Product : m_Products)
        {
            totalPrice += m_Product->price();
        }
...
//     Product *book1 = new Book ("Robinson Crusoe", 4.99);
//     Product *toy1 = new Toy {"Star Trooper", 39.99};
//     Product *toy2 = new Toy {"Barbie Dreamhouse", 59.99};
